                ...
                <div className="mx-auto grid max-w-[1350px] grid-cols-[1fr_1fr_1fr_1fr_auto] gap-8 px-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-white/80">
                            <li>
                                <Link href="tel:89007707021" className="text-[28px]  font-semibold text-white">8 900 770 7021</Link>
                                <p className="text-[18px] text-[#DADADA]">Звонок бесплатный</p>
                            </li>
                            <li>
                                <Link href="mailto:sales@kupibuket74.ru" className="text-[20px] ">sales@kupibuket74.ru</Link>
                            </li>
