...
export function Hero() {
    return (
        <section className="relative aspect-[1440/707] w-full overflow-hidden">
            <Image
                src="/images/flowers_main.jpg"
                alt="Цветы"
                fill
                priority
            ...
            <div className="relative z-10 flex h-full flex-col">
                <Header />
                <div className="flex flex-1 -mt-32 flex-col items-center justify-center gap-6">
                    <h1 className="text-center text-[48px] font-medium text-white">
                        Цветы, которые
                        {" "}
                        <br />
                        {" "}
                    ...
                    <Button variant="ghost" className="h-[56px] w-[249px] rounded-[10px] bg-white text-[20px] font-normal text-black">Посмотреть каталог</Button>
                </div>
                <div className="flex items-center justify-center gap-32 pb-8">
