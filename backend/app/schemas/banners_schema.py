...
class BannerCreate(BaseModel):
    title: str | None = Field(default=None, max_length=255, description="Заголовок баннера")
    description: str | None = Field(default=None, max_length=200, description="Краткое описание баннера")
    link: str | None = Field(default=None, max_length=512, description="Ссылка при клике")
...
class BannerResponse(BaseModel):
    ...
    description: str | None = Field(default=None, description="Краткое описание баннера")
