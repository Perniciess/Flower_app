...
from app.modules.pickup_points import service
...
async def create_pickup_point(
    ...
    """
    return await service.create_pickup_point(session, data)
...
async def get_active_pickup_points(
    ...
    """
    return await service.get_all_active_pickup_points(session)
...
async def get_all_pickup_points(
    ...
    """
    return await service.get_all_pickup_points(session)
...
async def get_pickup_point(
    ...
    """
    return await service.get_pickup_point_by_id(session, pickup_point_id)
...
async def update_pickup_point(
    ...
    """
    return await service.update_pickup_point(session, pickup_point_id, data)
...
async def delete_pickup_point(
    ...
    Требует права администратора.
    """
    await service.delete_pickup_point(session, pickup_point_id)
