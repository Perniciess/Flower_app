...
async def get_discounts(
    ...
    Требует прав администратора.
    """
    return await discounts_service.get_discounts(session=session)
...
async def update_discount(
    ...
    return await discounts_service.update_discount(
        session=session, discount_id=discount_id, discount_data=discount_data
    )
...
async def delete_discount(
    ...
    Требует прав администратора.
    """
    await discounts_service.delete_discount(session=session, discount_id=discount_id)
